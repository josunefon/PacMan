...
|-----------|----------|----------|
| Game logic & mechanics | Data | Game loop, collision, ghost AI, movement, scoring, Canvas rendering |
| HTML/CSS & UI | Mouth | Page layout, menus, HUD, responsive design, retro styling |
| Architecture & design | Mikey | Module boundaries, game state design, technical trade-offs |
